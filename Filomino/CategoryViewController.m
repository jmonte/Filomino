...
- (void)viewDidLoad
{
    ...
    themeName.font = [UIFont fontWithName:FONT_NAME size:30.0f];
    themeName.textAlignment = UITextAlignmentCenter;
    themeName.alpha = 0;
    [self.view addSubview:themeName];
    
    themeName.text = @"Select Packs";
    ...
    table = [[CategoryTableView alloc] initWithFrame:CGRectMake(0, screen_height ,self.view.frame.size.width ,self.view.frame.size.height - header_size +16 )];
    table.alpha = 0;
    table.separatorColor = [UIColor clearColor];
    table.categoryDelegate = self;
...
-(void)openCategory:(int)categoryID {
    viewController = [[LevelSelectionViewController alloc] initWithNibName:nil bundle:nil];
